...
def animate(i):
    ...
    for point in points:
        axes[1, 0].add_artist(plt.Circle(point, alpha, facecolor='blue', alpha=0.1, edgecolor='none'))
    ...
    for point in points:
        axes[1, 1].add_artist(plt.Circle(point, alpha, facecolor='blue', alpha=0.1, edgecolor='none'))
    ...
    axes[1, 1].set_title(f'4. Alpha Complex (α={alpha:.2f})')
